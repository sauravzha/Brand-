...
const ParticleNetwork3D = () => {
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 w-full h-full pointer-events-none opacity-30">
      {isInView && (
        <Canvas dpr={[1, 1.5]} camera={{ position: [0, 0, 8], fov: 60 }} gl={{ powerPreference: "high-performance", antialias: false, alpha: true }} style={{ background: 'transparent' }}>
