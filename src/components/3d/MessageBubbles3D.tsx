...
const MessageBubbles3D = () => {
  ...
  return (
    <div ref={containerRef} className="absolute right-0 top-0 w-full md:w-1/2 h-[400px] pointer-events-none opacity-40">
      {isInView && (
        <Canvas dpr={[1, 1.5]} gl={{ powerPreference: "high-performance", antialias: false, alpha: true }} camera={{ position: [0, 0, 6], fov: 50 }}>
